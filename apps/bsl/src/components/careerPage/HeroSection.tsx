...
const HeroSection = () => {
  ...
  return (
    <section
      className={` bg-[url('https://res.cloudinary.com/diek2uivi/image/upload/v1689582042/bsl-website/bsl/career/career_nkvozf.jpg')] h-[70vh] sm:h-[65vh] md:h-[68vh] bg-cover  bg-center top-0 `}
    >
